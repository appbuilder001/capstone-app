    ...
    return(
        <div className='flex-row just-se wrap gap' style={{height: 'auto', padding: '40px 20px 125px 20px', backgroundColor: 'var(--primary_color1)'}}>
            ...
            <section className='flex-row' style={{paddingTop: '20px'}}>
                <div className='radius' style={{backgroundImage: `url('${image1}')`, width: '276px', height: '338px', transform: 'translateY(100px)', backgroundSize: 'cover'}} alt='chef holding food'/>
                <div className='radius' style={{backgroundImage: `url('${image2}')`, width: '276px', height: '338px', backgroundPositionX: '-200px', backgroundSize: 'cover',transform: 'translateX(-100px)'}} alt='chef holding food'/>
            </section>
        </div>
    ) 
}
